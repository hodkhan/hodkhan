(() => {
    var e = {
        750: (e, t, n) => {
            ...
            i.push([e.id, "*[a],*[r],button{position:relative;overflow:hidden;-webkit-tap-highlight-color:transparent}.ripple{background-color:var(--r);opacity:.2;position:absolute;border-radius:50%;pointer-events:none;animation:ripple .3s ease-out}@keyframes ripple{from{transform:scale(0)}to{transform:scale(1)}}", ""]);
            const o = i
        }, 645: e => {
            "use strict";
            ...
            var a = n(755);
            a((() => {
                a(document).off("pointerdown pointerup mouseleave dragleave touchmove touchend touchcancel"), a(document).on("pointerdown", "*[a],*[r],button", (function (e) {
                ...
                })), a(document).on("pointerup mouseleave dragleave touchmove touchend touchcancel", "*[a],*[r],button", (function () {
