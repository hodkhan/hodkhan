/*! For license information please see ripples.js.LICENSE.txt */
(() => {
    var e = {
        750: (e, t, n) => {
            "use strict";
            ...
            i.push([e.id, ".md-ripples,button{position:relative;overflow:hidden;-webkit-tap-highlight-color:transparent}.ripples-light .ripple{background-color:#fff}.ripples-dark .ripple{background-color:#000}.ripple{background-color:#000;opacity:.16;position:absolute;border-radius:50%;pointer-events:none;animation:ripple .3s ease-out}@keyframes ripple{from{transform:scale(0)}to{transform:scale(1)}}", ""]);
            const o = i
        }, 645: e => {
            "use strict";
            ...
            !function (t, n) {
                ...
                var k = function (e) {
                    var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, m, y, x, b = "sizzle" + 1 * new Date,
                        ...
                        _ = new RegExp("^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*"),
                        z = new RegExp("^[\\x20\\t\\r\\n\\f]*([>+~]|[\\x20\\t\\r\\n\\f])[\\x20\\t\\r\\n\\f]*"),
                        U = new RegExp(R + "|>"), X = new RegExp(B), V = new RegExp("^" + I + "$"), Y = {
                            ID: new RegExp("^#(" + I + ")"),
                            CLASS: new RegExp("^\\.(" + I + ")"),
                            TAG: new RegExp("^(" + I + "|[*])"),
                            ATTR: new RegExp("^" + W),
                    ...
                    return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function (e, t) {
                        ...
                        if (n = n || [], 1 === d.length) {
                            ...
                            for (o = Y.needsContext.test(e) ? 0 : u.length; o-- && (l = u[o], !r.relative[c = l.type]);) if ((f = r.find[c]) && (i = f(l.matches[0].replace(te, ne), ee.test(u[0].type) && me(t.parentNode) || t))) {
                ...
                E.filter = function (e, t, n) {
                    ...
                    find: function (e) {
                        ...
                        return !!q(this, "string" == typeof e && j.test(e) ? E(e) : e || [], !1).length
                    }
                });
                var H, O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
                (E.fn.init = function (e, t, n) {
                    ...
                    if (n = n || H, "string" == typeof e) {
                        ...
                        if (r[1]) {
                            if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), L.test(r[1]) && E.isPlainObject(t)) for (r in t) m(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                            return this
                        }
                            ...
                            n = "pending", i = {
                                state: function () {
                                        ...
                                        return function () {
                                            var s = this, u = arguments, l = function () {
                                                ...
                                                if (!(e < o)) {
                                                    ...
                                                    l = r && ("object" == typeof r || "function" == typeof r) && r.then, m(l) ? i ? l.call(r, a(o, t, W, i), a(o, t, B, i)) : (o++, l.call(r, a(o, t, W, i), a(o, t, B, i), a(o, t, W, t.notifyWith))) : (n !== W && (s = void 0, u = [r]), (i || t.resolveWith)(s, u))
                                                }
                                            }, c = i ? l : function () {
                                                try {
                                                    l()
                                                } catch (r) {
                                                    E.Deferred.exceptionHook && E.Deferred.exceptionHook(r, c.stackTrace), e + 1 >= o && (n !== B && (s = void 0, u = [r]), t.rejectWith(s, u))
                                                }
                                            };
                                    ...
                                    return E.Deferred((function (r) {
                                        t[0][3].add(a(0, r, m(i) ? i : W, r.notifyWith)), t[1][3].add(a(0, r, m(e) ? e : W)), t[2][3].add(a(0, r, m(n) ? n : B))
                                    })).promise()
                                }, promise: function (e) {
                ...
                function Ce(e, t, n, r, i) {
                    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === T(o)) E.merge(p, o.nodeType ? [o] : o); else if (Te.test(o)) {
                        for (a = a || f.appendChild(t.createElement("div")), s = (me.exec(o) || ["", ""])[1].toLowerCase(), u = xe[s] || xe._default, a.innerHTML = u[1] + E.htmlPrefilter(o) + u[2], c = u[0]; c--;) a = a.lastChild;
                        E.merge(p, a.childNodes), (a = f.firstChild).textContent = ""
                    } else p.push(t.createTextNode(o));
                    for (f.textContent = "", d = 0; o = p[d++];) if (r && E.inArray(o, r) > -1) i && i.push(o); else if (l = se(o), a = be(f.appendChild(o), "script"), l && we(a), n) for (c = 0; o = a[c++];) ye.test(o.type || "") && n.push(o);
                    return f
                }
                ...
                function Ie(e, t, n, r) {
                    ...
                    if (p && (o = (i = Ce(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                        ...
                        if (s) for (c = a[a.length - 1].ownerDocument, E.map(a, Pe), f = 0; f < s; f++) l = a[f], ye.test(l.type || "") && !K.access(l, "globalEval") && E.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && !l.noModule && E._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}, c) : w(l.textContent.replace(qe, ""), l, c))
                    }
                    return e
                }
                ...
                E.extend({
                    htmlPrefilter: function (e) {
                        ...
                        if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e))) for (a = be(s), r = 0, i = (o = be(e)).length; r < i; r++) Re(o[r], a[r]);
                ...
                function ze(e, t, n) {
                    ...
                    return (n = n || Fe(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || se(e) || (a = E.style(e, t)), !v.pixelBoxStyles() && Be.test(a) && _e.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
                }
                ...
                var Xe = ["Webkit", "Moz", "ms"], Ve = x.createElement("div").style, Ye = {};

                function Ge(e) {
                    return E.cssProps[e] || Ye[e] || (e in Ve ? e : Ye[e] = function (e) {
                ...
                function nt(e, t, n) {
                    var r = Fe(e), i = (!v.boxSizingReliable() || n) && "border-box" === E.css(e, "boxSizing", !1, r),
                ...
                E.extend({
                    ...
                    style: function (e, t, n, r) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            var i, o, a, s = G(t), u = Je.test(t), l = e.style;
                    ...
                    css: function (e, t, n, r) {
                        var i, o, a, s = G(t);
                        return Je.test(t) || (t = Ge(s)), (a = E.cssHooks[t] || E.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = ze(e, t, r)), "normal" === i && t in Ze && (i = Ze[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                    }
                    ...
                    E.cssHooks[t] = {
                        get: function (e, n, r) {
                            ...
                            var i, o = Fe(e), a = !v.scrollboxSize() && "absolute" === o.position,
                ...
                function pt(e, t, n) {
                    ...
                    for (function (e, t) {
                        var n, r, i, o, a;
                        for (n in e) if (i = t[r = G(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = E.cssHooks[r]) && "expand" in a) for (n in o = a.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i); else t[r] = i
                    }(c, l.opts.specialEasing); o < a; o++) if (r = pt.prefilters[o].call(l, e, c, l.opts)) return m(r.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
                ...
                E.fn.extend({
                    ...
                    addClass: function (e) {
                        ...
                        if ((t = xt(e)).length) for (; n = this[u++];) if (i = yt(n), r = 1 === n.nodeType && " " + mt(i) + " ") {
                        ...
                        return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : m(e) ? this.each((function (n) {
                            ...
                            var t, i, o, a;
                            if (r) for (i = 0, o = E(this), a = xt(e); t = a[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || ((t = yt(this)) && K.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : K.get(this, "__className__") || ""))
                        }))
                    }, hasClass: function (e) {
                        var t, n, r = 0;
                ...
                E.extend(E.event, {
                    trigger: function (e, t, n, i) {
                        ...
                        if (a = p = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !wt.test(g + E.event.triggered) && (g.indexOf(".") > -1 && (v = g.split("."), g = v.shift(), v.sort()), l = g.indexOf(":") < 0 && "on" + g, (e = e[E.expando] ? e : new E.Event(g, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), f = E.event.special[g] || {}, i || !f.trigger || !1 !== f.trigger.apply(n, t))) {
                            ...
                            return e.type = g, i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !Q(n) || l && m(n[g]) && !y(n) && ((s = n[l]) && (n[l] = null), E.event.triggered = g, e.isPropagationStopped() && p.addEventListener(g, Tt), n[g](), e.isPropagationStopped() && p.removeEventListener(g, Tt), E.event.triggered = void 0, s && (n[l] = s)), e.result
                        }
                ...
                Bt.href = Ct.href, E.extend({
                    ...
                    ajax: function (e, t) {
                        ...
                        var n, i, o, a, s, u, l, c, f, p, d = E.ajaxSetup({}, t), h = d.context || d,
                            ...
                            m = E.Callbacks("once memory"), y = d.statusCode || {}, b = {}, w = {}, T = "canceled",
                            C = {
                        ...
                        if (v.promise(C), d.url = ((e || d.url || Ct.href) + "").replace(Mt, Ct.protocol + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(I) || [""], null == d.crossDomain) {
                            u = x.createElement("a");
                            try {
                        ...
                        if (d.data && d.processData && "string" != typeof d.data && (d.data = E.param(d.data, d.traditional)), $t(Rt, d, t, C), l) return C;
                        ...
                        if (T = "abort", m.add(d.complete), C.done(d.success), C.fail(d.error), n = $t(It, d, t, C)) {
                ...
                E.ajaxSetup({
                    ...
                    if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Yt, "$1" + i) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
                        ...
                        void 0 === o ? E(r).removeProp(i) : r[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Vt.push(i)), a && m(o) && o(a[0]), a = o = void 0
                    })), "script"
                    ...
                    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (v.createHTMLDocument ? ((r = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href, t.head.appendChild(r)) : t = x), o = !n && [], (i = L.exec(e)) ? [t.createElement(i[1])] : (i = Ce([e], t, o), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
                    var r, i, o
                }, E.fn.load = function (e, t, n) {
                    var r, i, o, a = this, s = e.indexOf(" ");
                    return s > -1 && (r = mt(e.slice(s)), e = e.slice(0, s)), m(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && E.ajax({
                        url: e,
                        type: i || "GET",
                        dataType: "html",
                        data: t
                    ...
                    E.cssHooks[t] = Ue(v.pixelPosition, (function (e, n) {
                        if (n) return n = ze(e, t), Be.test(n) ? E(e).position()[t] + "px" : n
                    }))
                ...
                }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = D, E.isFunction = m, E.isWindow = y, E.camelCase = G, E.type = T, E.now = Date.now, E.isNumeric = function (e) {
                    var t = E.type(e);
            ...
            function s(e, t) {
                for (var n = {}, r = [], i = 0; i < e.length; i++) {
                    var s = e[i], u = t.base ? s[0] + t.base : s[0], l = n[u] || 0, c = "".concat(u, " ").concat(l);
                    n[u] = l + 1;
                    var f = a(c), p = {css: s[1], media: s[2], sourceMap: s[3]};
            ...
            function g(e, t) {
                ...
                if (t.singleton) {
                    var o = h++;
                    n = d || (d = u(t)), r = f.bind(null, n, o, !1), i = f.bind(null, n, o, !0)
            ...
            "use strict";
            var r = n(379), i = n.n(r), o = n(750);
            i()(o.Z, {insert: "head", singleton: !1}), o.Z.locals;
            var a = n(755);
            a((() => {
                a(document).off("pointerdown pointerup mouseleave dragleave touchmove touchend touchcancel"), a(document).on("pointerdown", ".md-ripples,button", (function (e) {
                    const t = this.getBoundingClientRect(), n = function (e, t, n, r, i, o) {
                        const a = e - n > t / 2 ? 0 : t, s = r - o > i / 2 ? 0 : i;
                        return Math.hypot(a - (e - n), s - (r - o))
                    }(e.clientX, this.offsetWidth, t.left, e.clientY, this.offsetHeight, t.top);
                    let r = document.createElement("div");
                    a(r).addClass("ripple"), a(r).css({
                        top: e.clientY - t.top - n + "px",
                        left: e.clientX - t.left - n + "px",
                        width: 2 * n + "px",
                        height: 2 * n + "px"
                    }), a(this).append(r)
                })), a(document).on("pointerup mouseleave dragleave touchmove touchend touchcancel", ".md-ripples,button", (function () {
                    const e = a(this).find(".ripple");
                    0 != e.length && e.animate({opacity: 0}, 600, (function () {
                        e.remove()
                    }))
                }))
            }))
    ...
    }, n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), n(755), n(66)
})();