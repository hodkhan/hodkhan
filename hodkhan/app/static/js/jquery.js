!function (e, t) {
    ...
    function V(e, t, n) {
        var r, i;
        if (void 0 === n && 1 === e.nodeType) if (r = "data.json-" + t.replace(U, "-$&").toLowerCase(), "string" == typeof (n = e.getAttribute(r))) {
            try {
        ...
        data: function (n, e) {
            ...
            if (void 0 === n) {
                if (this.length && (i = z.get(o), 1 === o.nodeType && !_.get(o, "hasDataAttrs"))) {
                    t = a.length;
                    while (t--) a[t] && 0 === (r = a[t].name).indexOf("data.json-") && (r = F(r.slice(5)), V(o, r, i[r]));
    ...
    le.cors = !!Qt && "withCredentials" in Qt, le.ajax = Qt = !!Qt, ce.ajaxTransport(function (i) {
        ...
        if (n.crossDomain || n.scriptAttrs) return {
            send: function (e, t) {
                r = ce("<src>").attr(n.scriptAttrs || {}).prop({
